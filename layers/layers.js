...
lyr_SriLankaDistricts_1.set('fieldLabels', {'shapeName': 'inline label - always visible', 'shapeISO': 'inline label - visible with data', 'shapeID': 'no label', 'shapeGroup': 'no label', 'shapeType': 'no label', });
