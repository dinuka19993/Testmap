...
map.getView().fit([7848175.748121, -336080.181823, 10705978.314591, 1509220.545761], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Test Map 1</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (68 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This web map shows the main Transport routes and waterways Srilanaka';
            }
